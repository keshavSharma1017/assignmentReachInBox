...
import { handleAuthCallback } from '../services/authService.js'
    ...
    <div className="login-page">
      <div className="login-container">
        ...
        <div className="logo-container">
          ...
          <p className="app-tagline">Manage your emails efficiently</p>
        </div>
        
        <div className="login-card">
          <h2>Welcome to ReachInbox</h2>
          <p className="login-description">
            Your streamlined email experience. Sign in to access your inbox.
          </p>
